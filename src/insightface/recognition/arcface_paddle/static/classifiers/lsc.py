...
class LargeScaleClassifier(object):
    ...
    def __init__(self,
        ...
        # Updated L2 normalization method
        norm_feature = paddle.nn.functional.normalize(total_feature, p=2, axis=1)
        norm_weight = paddle.nn.functional.normalize(weight, p=2, axis=0)
        ...
        loss.desc.set_dtype(paddle.core.VarDesc.VarType.FP32)
